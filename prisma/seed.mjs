...
const metadataGroups = [
  ...
  { slug: "lats", label: "Lats", kind: "MUSCLE_GROUP", appliesToExercise: true, appliesToRoutine: false, parentSlugs: ["back", "pull", "upper-body"] },
  { slug: "upper-back", label: "Upper Back", kind: "MUSCLE_GROUP", appliesToExercise: true, appliesToRoutine: false, parentSlugs: ["back", "pull", "upper-body"] },
  { slug: "lower-back", label: "Lower Back", kind: "MUSCLE_GROUP", appliesToExercise: true, appliesToRoutine: false, parentSlugs: ["back", "upper-body"] },
  { slug: "abs", label: "Abs", kind: "MUSCLE_GROUP", appliesToExercise: true, appliesToRoutine: false, parentSlugs: ["core"] },
  { slug: "obliques", label: "Obliques", kind: "MUSCLE_GROUP", appliesToExercise: true, appliesToRoutine: false, parentSlugs: ["core"] },
  { slug: "glute-medius", label: "Glute Medius", kind: "MUSCLE_GROUP", appliesToExercise: true, appliesToRoutine: false, parentSlugs: ["glutes", "legs", "lower-body"] },
  { slug: "tibialis", label: "Tibialis", kind: "MUSCLE_GROUP", appliesToExercise: true, appliesToRoutine: false, parentSlugs: ["legs", "lower-body"] },
  ...
  // CARDIO_ACTIVITY: activity type tagging — first-class metadata for cardio + sport activities.
  // Hierarchy: cardio → run-walk → running/walking → variants. Each level is its own taggable entity.
...
const sessionTemplates = [
  ...
  {
    key: "outdoor-top-rope",
    name: "Outdoor Top Rope",
    description: "Track outdoor top rope sessions with grade rows, onsights/flashes, and clean sends.",
    sessionSubtype: "CLIMBING",
    sortOrder: 24.5,
    metadataSlugs: climbingOutdoorTemplateMetadata,
    metrics: [
...
const starterExercises = [
  ...
  { name: "Wide Grip Pull-Up", unit: "REPS", supportsWeight: true, metadata: ["back", "lats", "biceps", "pull", "upper-body", "vertical-pull"] },
  ...
  { name: "Scapular Pull-Up", unit: "REPS", supportsWeight: false, metadata: ["back", "shoulders", "pull", "upper-body", "vertical-pull", "skill-practice"] },
  { name: "Archer Pull-Up", unit: "REPS", supportsWeight: true, metadata: ["back", "lats", "biceps", "pull", "upper-body", "vertical-pull", "skill-practice", "strength"] },
  ...
  { name: "Banded Pull-Apart", unit: "REPS", supportsWeight: false, metadata: ["back", "shoulders", "pull", "upper-body", "horizontal-pull", "rehab"] },
  { name: "Band Face Pull", unit: "REPS", supportsWeight: false, metadata: ["back", "shoulders", "pull", "upper-body", "horizontal-pull", "rehab"] },
  { name: "Band Row", unit: "REPS", supportsWeight: false, metadata: ["back", "biceps", "pull", "upper-body", "horizontal-pull"] },
  { name: "Band Shoulder External Rotation", unit: "REPS", supportsWeight: false, metadata: ["shoulders", "upper-body", "mobility", "rehab"] },
  { name: "Band Shoulder Internal Rotation", unit: "REPS", supportsWeight: false, metadata: ["shoulders", "upper-body", "mobility", "rehab"] },
  { name: "Dip", unit: "REPS", supportsWeight: true, metadata: ["chest", "triceps", "shoulders", "push", "upper-body", "vertical-push"] },
  { name: "Ring Dip", unit: "REPS", supportsWeight: true, metadata: ["chest", "triceps", "shoulders", "core", "push", "upper-body", "vertical-push", "skill-practice"] },
  ...
  { name: "Muscle-Up", unit: "REPS", supportsWeight: true, metadata: ["back", "chest", "shoulders", "triceps", "biceps", "core", "pull", "push", "upper-body", "full-body", "vertical-pull", "vertical-push", "skill-practice", "strength"] },
  ...
  { name: "Pogo Jump", unit: "REPS", supportsWeight: false, metadata: ["calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Ankle Hop", unit: "REPS", supportsWeight: false, metadata: ["calves", "tibialis", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Squat Jump", unit: "REPS", supportsWeight: false, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Countermovement Jump", unit: "REPS", supportsWeight: false, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Tuck Jump", unit: "REPS", supportsWeight: false, metadata: ["quads", "hip-flexors", "calves", "core", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Broad Jump", unit: "REPS", supportsWeight: false, metadata: ["glutes", "hamstrings", "quads", "calves", "legs", "lower-body", "hinge", "skill-practice"] },
  { name: "Standing Long Jump", unit: "REPS", supportsWeight: false, metadata: ["glutes", "hamstrings", "quads", "calves", "legs", "lower-body", "hinge", "skill-practice"] },
  { name: "Box Jump", unit: "REPS", supportsWeight: false, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Box Jump Over", unit: "REPS", supportsWeight: false, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Lateral Box Jump", unit: "REPS", supportsWeight: false, metadata: ["quads", "glutes", "abductors", "adductors", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Depth Jump", unit: "REPS", supportsWeight: false, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Drop Jump", unit: "REPS", supportsWeight: false, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Lateral Bound", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "abductors", "adductors", "quads", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  { name: "Skater Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "abductors", "adductors", "quads", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  { name: "Speed Skater Hop", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "abductors", "adductors", "quads", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  { name: "Bounding", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "hamstrings", "quads", "calves", "hip-flexors", "legs", "lower-body", "hinge", "skill-practice"] },
  { name: "Power Skip", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "hamstrings", "quads", "calves", "hip-flexors", "legs", "lower-body", "hinge", "skill-practice"] },
  { name: "Single-Leg Pogo Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["calves", "tibialis", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Single-Leg Hop", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Single-Leg Broad Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "hamstrings", "quads", "calves", "legs", "lower-body", "hinge", "skill-practice"] },
  { name: "Single-Leg Lateral Hop", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "abductors", "adductors", "quads", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  { name: "Single-Leg Medial Hop", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["glutes", "abductors", "adductors", "quads", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  { name: "Single-Leg Forward Hop", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Single-Leg Box Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Single-Leg Drop Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Single-Leg Depth Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "squat", "skill-practice"] },
  { name: "Split Squat Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  { name: "Alternating Lunge Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  { name: "Scissor Jump", unit: "REPS", supportsWeight: false, isUnilateral: true, metadata: ["quads", "glutes", "calves", "legs", "lower-body", "lunge", "skill-practice"] },
  ...
  { name: "Single-Leg Hamstring Curl", unit: "REPS", supportsWeight: true, isUnilateral: true, metadata: ["hamstrings", "legs", "lower-body"] },
  ...
  { name: "90/90 Hip Switch", unit: "REPS", supportsWeight: false, metadata: ["glutes", "hip-flexors", "adductors", "abductors", "mobility", "rehab"] },
  { name: "Hip CARs", unit: "REPS", supportsWeight: false, metadata: ["glutes", "hip-flexors", "adductors", "abductors", "rotation", "mobility", "rehab"] },
  { name: "Shoulder CARs", unit: "REPS", supportsWeight: false, metadata: ["shoulders", "upper-body", "rotation", "mobility", "rehab"] },
  { name: "Scapular CARs", unit: "REPS", supportsWeight: false, metadata: ["shoulders", "upper-back", "upper-body", "mobility", "rehab"] },
  { name: "Wrist CARs", unit: "REPS", supportsWeight: false, metadata: ["forearms", "grip", "upper-body", "rotation", "mobility", "rehab"] },
  { name: "Ankle CARs", unit: "REPS", supportsWeight: false, metadata: ["calves", "tibialis", "legs", "lower-body", "rotation", "mobility", "rehab"] },
  { name: "Neck CARs", unit: "REPS", supportsWeight: false, metadata: ["neck", "upper-body", "rotation", "mobility", "rehab"] },
  ...
  { name: "Wrist Flexion Curl", unit: "REPS", supportsWeight: true, metadata: ["forearms", "grip", "pull", "upper-body", "rehab"] },
  { name: "Wrist Extension Curl", unit: "REPS", supportsWeight: true, metadata: ["forearms", "grip", "pull", "upper-body", "rehab"] },
  { name: "Reverse Wrist Curl", unit: "REPS", supportsWeight: true, metadata: ["forearms", "grip", "pull", "upper-body", "rehab"] },
  { name: "Wrist Pronation", unit: "REPS", supportsWeight: true, metadata: ["forearms", "grip", "upper-body", "rotation", "rehab"] },
  { name: "Wrist Supination", unit: "REPS", supportsWeight: true, metadata: ["forearms", "grip", "upper-body", "rotation", "rehab"] },
  { name: "Wrist Radial Deviation", unit: "REPS", supportsWeight: true, metadata: ["forearms", "grip", "upper-body", "rehab"] },
  { name: "Wrist Ulnar Deviation", unit: "REPS", supportsWeight: true, metadata: ["forearms", "grip", "upper-body", "rehab"] },
  ...
  { name: "Banded Terminal Knee Extension", unit: "REPS", supportsWeight: false, metadata: ["quads", "legs", "lower-body", "squat", "rehab"] },
  { name: "Quad Set", unit: "TIME", supportsWeight: false, metadata: ["quads", "legs", "lower-body", "isometric", "rehab"] },
  { name: "Straight Leg Raise", unit: "REPS", supportsWeight: false, metadata: ["quads", "hip-flexors", "legs", "lower-body", "rehab"] },
  { name: "Isometric Hamstring Curl", unit: "TIME", supportsWeight: false, metadata: ["hamstrings", "legs", "lower-body", "hinge", "isometric"] },
  { name: "Single-Leg Isometric Hamstring Curl", unit: "TIME", supportsWeight: false, isUnilateral: true, metadata: ["hamstrings", "legs", "lower-body", "hinge", "isometric"] },
  { name: "Heel Slide", unit: "REPS", supportsWeight: false, metadata: ["hamstrings", "quads", "legs", "lower-body", "mobility", "rehab"] },
  ...
  { name: "Tibialis Raise", unit: "REPS", supportsWeight: false, metadata: ["tibialis", "calves", "legs", "lower-body", "rehab"] },
  { name: "Heel Walk", unit: "TIME", supportsWeight: false, metadata: ["tibialis", "calves", "legs", "lower-body", "rehab"] },
  { name: "Toe Walk", unit: "TIME", supportsWeight: false, metadata: ["calves", "legs", "lower-body", "rehab"] },
  { name: "Band Ankle Inversion", unit: "REPS", supportsWeight: false, metadata: ["calves", "tibialis", "legs", "lower-body", "rehab"] },
  { name: "Band Ankle Eversion", unit: "REPS", supportsWeight: false, metadata: ["calves", "tibialis", "legs", "lower-body", "rehab"] },
  ...
  { name: "Clamshell", unit: "REPS", supportsWeight: false, metadata: ["glutes", "abductors", "legs", "lower-body", "rehab"] },
  { name: "Banded Clamshell", unit: "REPS", supportsWeight: false, metadata: ["glutes", "abductors", "legs", "lower-body", "rehab"] },
  { name: "Banded Side Step", unit: "REPS", supportsWeight: false, metadata: ["glutes", "abductors", "legs", "lower-body", "rehab"] },
  { name: "Lateral Band Walk", unit: "REPS", supportsWeight: false, metadata: ["glutes", "abductors", "legs", "lower-body", "rehab"] },
  { name: "Monster Walk", unit: "REPS", supportsWeight: false, metadata: ["glutes", "abductors", "legs", "lower-body", "rehab"] },
  { name: "Banded Monster Walk", unit: "REPS", supportsWeight: false, metadata: ["glutes", "abductors", "legs", "lower-body", "rehab"] },
  { name: "Banded Hip Abduction", unit: "REPS", supportsWeight: false, metadata: ["glutes", "abductors", "legs", "lower-body", "rehab"] },
  { name: "Hip Airplane", unit: "REPS", supportsWeight: false, metadata: ["glutes", "hamstrings", "hip-flexors", "legs", "lower-body", "hinge", "rotation", "rehab"] },
  ...
  { name: "One-Arm Dead Hang", unit: "TIME", supportsWeight: false, isUnilateral: true, metadata: ["back", "shoulders", "forearms", "fingers", "pull", "upper-body", "isometric"] },
  { name: "Active Hang", unit: "TIME", supportsWeight: false, metadata: ["back", "shoulders", "forearms", "fingers", "pull", "upper-body", "isometric"] },
  { name: "Pinch Hold", unit: "TIME", supportsWeight: true, metadata: ["fingers", "forearms", "grip", "pull", "upper-body", "isometric", "strength"] },
  ...fingerPullExercises,
  ...
  { name: "Tuck Front Lever Hold", unit: "TIME", supportsWeight: false, metadata: ["back", "lats", "shoulders", "core", "pull", "upper-body", "isometric", "skill-practice"] },
  { name: "Front Lever Hold", unit: "TIME", supportsWeight: false, metadata: ["back", "lats", "shoulders", "core", "pull", "upper-body", "isometric", "skill-practice", "strength"] },
  { name: "Planche Lean", unit: "TIME", supportsWeight: false, metadata: ["chest", "shoulders", "triceps", "core", "push", "upper-body", "isometric", "skill-practice"] },
  { name: "Tuck Planche Hold", unit: "TIME", supportsWeight: false, metadata: ["chest", "shoulders", "triceps", "core", "push", "upper-body", "isometric", "skill-practice", "strength"] },
  ...
  { name: "Prone T Raise", unit: "REPS", supportsWeight: false, metadata: ["shoulders", "upper-back", "pull", "upper-body", "rehab"] },
  { name: "Prone W Raise", unit: "REPS", supportsWeight: false, metadata: ["shoulders", "upper-back", "pull", "upper-body", "rehab"] },
  { name: "Cuban Rotation", unit: "REPS", supportsWeight: true, metadata: ["shoulders", "upper-back", "pull", "upper-body", "rotation", "rehab"] },
