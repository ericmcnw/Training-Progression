...
export default function DeleteLogButton({ logId }: { logId: string }) {
  ...
  return (
    <>
      ...
      {isConfirmOpen && (
        <div style={overlayStyle} role="dialog" aria-modal="true" aria-label="Delete log confirmation">
          <div style={modalStyle}>
            <div style={{ fontSize: 16, fontWeight: 900 }}>Are you sure you want to delete this log?</div>
            <div style={{ marginTop: 8, fontSize: 13, opacity: 0.8 }}>
              This log entry and its set details will be removed.
            </div>
