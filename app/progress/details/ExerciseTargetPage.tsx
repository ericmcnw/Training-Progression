...
import { fillWeeklySeries, getRangeFromSearchParam, incrementWeekMap, normalizeProgressTab, rangeChipLabel, resolveProgressTab, trendLabel } from "@/lib/progress-v2";
  ...
  return (
    <>
      <TargetHeader
        ...
        tab={tab}
        range={range}
        actions={<SectionLinkButton href="/progress?section=exercises" label="Back to Exercises" />}
      />
