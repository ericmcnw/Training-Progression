...
const METRICS_BY_COMBINATION: Record<GoalTypeValue, Partial<Record<GoalTargetTypeValue, GoalMetricTypeValue[]>>> = {
  ...
  VOLUME: {
    ROUTINE: ["DISTANCE", "DURATION", "ELEVATION_GAIN", "REPS", "SETS", "VOLUME", "SESSION_METRIC"],
    EXERCISE: ["REPS", "SETS", "VOLUME", "DURATION"],
    CARDIO: ["DISTANCE", "DURATION", "ELEVATION_GAIN"],
    GROUP: ["DISTANCE", "DURATION", "ELEVATION_GAIN", "REPS", "SETS", "VOLUME"],
    SESSION_TEMPLATE: ["DURATION", "SESSION_METRIC"],
  },
  PERFORMANCE: {
    ROUTINE: ["DISTANCE", "ELEVATION_GAIN", "MAX_DURATION", "SESSION_METRIC"],
    EXERCISE: ["MAX_WEIGHT", "MAX_DURATION"],
    CARDIO: ["DISTANCE", "ELEVATION_GAIN", "PACE"],
    GROUP: [],
