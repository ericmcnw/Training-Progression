...
// Assigned in order of routine total-volume (heaviest first gets the
// first color). See lib/activities/routine-palette.ts for the ordering
// rationale — shared with the climbing training chart.
import { ROUTINE_PALETTE } from "./routine-palette";
